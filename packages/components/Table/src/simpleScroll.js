export default (function(w,d){
	function S(){
        this.d = typeof arguments[0] === 'string' ?  d.querySelector(arguments[0]) : arguments[0];
        if(!this.d){
        	alert('not find dom');
        };
        this.offset = 0;
    ...
    S.prototype.createBar = function(){
    	...
    	this.d.appendChild(sitem);
    	this.bar = this.d.querySelector('.scroll-bar');
    	this.barCon = this.d.querySelector('.scroll-barCon');
    };
