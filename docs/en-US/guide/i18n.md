...
import zhCn from 'wisdom-plus/es/locale/lang/zh-cn'
...
<script>
  ...
  import { ElConfigProvider } from 'wisdom-plus'

  import zhCn from 'wisdom-plus/lib/locale/lang/zh-cn'
...
```html
<script src="//unpkg.com/wisdom-plus/dist/locale/zh-cn">
  <script>
  app.use(ElementPlus, {
...
[Supported Language List](https://github.com/wisdom-plus/wisdom-plus/tree/dev/packages/locale/lang)
...
If you need any other languages, [PR](https://github.com/wisdom-plus/wisdom-plus/pulls)
is always welcomed, you only need to add a language file at
[here](https://github.com/wisdom-plus/wisdom-plus/tree/dev/packages/locale/lang).
...
```typescript
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(
      /wisdom-plus[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]en/,
      'wisdom-plus/lib/locale/lang/zh-cn'
    ),
  ]
}
```
