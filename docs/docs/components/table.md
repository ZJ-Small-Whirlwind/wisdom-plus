...
const columns = ref([
    ...
    { prop: "date", number: true, width:50},
...
const columns = ref([
    {label: ["星期","课程","时间"], prop: "time", width: 140},
...
const data = ref([
    {
        time: '8:00-10:00',
        kc: ["语文", "数学", "英语", "化学", "地理", "历史", "数学"],
    },
    {
        time: '10:00-12:00',
        kc: ["语文", "地理", "地理", "语文", "英语", "美术", "地理"],
    },
    {
        time: '14:00-16:00',
        kc: ["语文", "数学", "英语", "化学", "英语", "体育", "数学"],
    },
    {
        time: '16:00-18:00',
        kc: ["语文", "数学", "英语", "化学", "地理", "美术", "数学"],
    },
    {
        time: '19:00-21:00',
        kc: ["语文", "地理", "英语", "化学", "英语", "美术", "地理"],
    },
    {
        time: '21:00-23:00',
        kc: ["地理", "数学", "地理", "语文", "地理", "体育", "地理"],
    }
])
const add = (item) => {
    console.log(item)
...
| edit           | 快捷编辑                                                                  | _boolean, editConfig_                                                   | false                   |
| editIcon       | 是否显示编辑图标                                                              | _boolean_                                                               | flase                   |
...
| btns > show    | 操作按钮显示隐藏过滤方法                                                          | _boolean, ({label, column, row, editValueKeyName, btnConfig})=>boolean_ | -                       |
...
| remote-success | 远程数据加载成功回调 | _({ev, bool, row, res})=>void_                      |
| remote-error | 远程数据加载错误回调 | _(error:any)=>void_                      |
